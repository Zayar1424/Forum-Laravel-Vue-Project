<template>
    <div class="min-h-screen md:bg-gradient-to-br md:from-indigo-100 md:via-white md:to-purple-100 md:py-16 md:px-4">
        <div class="max-w-3xl mx-auto bg-white rounded-2xl shadow-2xl p-5 md:p-10">
            <!-- Back Button and Thread Title -->
            <div class="flex flex-col gap-4 mb-4">
                <button
                    @click="goBack"
                    class="flex items-center gap-2 px-3 py-2 bg-indigo-100 text-indigo-700 rounded-lg hover:bg-indigo-200 transition font-semibold shadow w-24"
                >
